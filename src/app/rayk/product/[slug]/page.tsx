...
export async function generateMetadata({ params }: Params): Promise<Metadata> {
  ...
  const desc = product.shortDescription ?? (product.description ? product.description.slice(0, 155) : `${product.name} – unique 3D printed gift by RAYK. Delivered across Egypt.`);
